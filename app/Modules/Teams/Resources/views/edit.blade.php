                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea required type="text" class="form-control" id="description" name="description">{{$team->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="jira_project_key"  name="jira_project_key" value="{{$team->jira_project_key}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
