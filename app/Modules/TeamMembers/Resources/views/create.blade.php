...
@section('title')
    {!! config('teammembers.name') !!} - Create
@endsection
            ...
            <div class="modern-form-group">
                ...
                <div class="range-slider-wrapper">
                    <input 
                        ...
                        required
                    >
                    <span class="range-value-display" id="weight-display">{{ old('weight', 0) }}</span>
                </div>
                @error('weight')
                    <div class="modern-form-error">{{ $message }}</div>
                @enderror
...
@include('partials.modern-form-wrapper', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Create Team Member', 'url' => null]
    ],
    'headerButtons' => [
        [
            'label' => 'Back to List', 
    ...
    'formTitle' => 'Add Team Member Form',
